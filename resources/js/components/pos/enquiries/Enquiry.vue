...
<script>
  ...
  import purchase_enquiries from "../../../store/modules/purchase_enquiries";
    export default {
        props:['edit'],
        data(){
            return {
          ...
          saveEnquiry(){
            ...
            save(){
                ...
                axios.post('enquiry',this.form)
                    .then(res => {
                        this.$store.state.purchase_enquiries.all_my_enquiries.unshift(res.data);
            ...
            listen(){
                if (this.edit){
                    this.form = this.$store.state.purchase_enquiries.enquiry;
                   // setTimeout(()=>{
